...
export const declarationPost = exchange.post;
export const declarationEarlierComments = exchange.comments.filter(act => Date.parse(act.occurred_at) < Date.parse(declarationQuestion.occurred_at));
