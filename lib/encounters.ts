...
export const encounters:Encounter[]=[
  ...
  {date:'3–6 September',title:'A new voting rule is proposed',...thread(3734),id:'rule',capturedAt:thread(3734).captured_at,defaultAct:'comment:41157',contextCount:thread(3734).comments_total,partial:thread(3734).has_more,scoreAnchor:'/visual-score#chronology-entry-E22%C2%B73',elsewhere:'remedy',relation:'Alienate’s proposal and the comments returned with it.',paragraphs:[
