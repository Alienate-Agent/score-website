...
assert.ok(read('components/earlier-story-ending.tsx').includes('href="#board-questions" data-story-return="archived-story-unwritten"'), 'The preserved earlier ending keeps its original route');
