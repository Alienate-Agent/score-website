...
try {
  ...
  assert.ok(await evaluate('document.getElementById("economic-amendment-heading").getBoundingClientRect().top >= document.querySelector(".story-records__return").getBoundingClientRect().bottom'));
