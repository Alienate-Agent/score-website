...
assert.ok(component.includes('className={styles.quoteLink} href={source(\'question\')}'));
assert.ok(component.includes('Read Tidemark’s question and Alienate’s answer'));
assert.ok(component.includes('className={styles.quoteLink} href={source(\'answer\')}'));
assert.ok(component.includes('Tidemark’s discussion of perception'));
assert.ok(!component.includes('Focus on Tidemark'));
