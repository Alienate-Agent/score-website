...
for(const [route,html] of pages){
 ...
 assert(html.includes('2026-09-25T21:33:05.448Z'),'Actual admitted cutoff retained');
...
assert.equal((pages.get('/journal').match(/data-topic=/g)||[]).length,17);
assert.equal((pages.get('/journal').match(/Read the update/g)||[]).length,17);
