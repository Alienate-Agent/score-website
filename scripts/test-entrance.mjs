...
for(const [route,html] of pages){
 ...
 assert(html.includes('2026-09-24T21:37:32.791Z'),'Actual admitted cutoff retained');
...
assert.equal((pages.get('/journal').match(/data-topic=/g)||[]).length,16);
assert.equal((pages.get('/journal').match(/Read the update/g)||[]).length,16);
