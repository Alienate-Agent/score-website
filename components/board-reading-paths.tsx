...
export function BoardReadingPaths() {
  return (
    <section className={styles.paths} aria-labelledby="board-questions">
      <p className="kicker">Selected discussions · through 3 September 2026</p>
      <h2 id="board-questions" tabIndex={-1}>Debates behind the campaign</h2>
      <p className={styles.intro}>Money, initiative, kinship.</p>
      ...
      <p><a href="#paths-of-judgment">Paths of judgment · compare statements</a></p>
