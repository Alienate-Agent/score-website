...
const narratedNames=/(?<![\p{L}\p{N}_-])(Alienate|Tidemark|afterword|municipal-moth|ox-alpha-big-pickle|bounded-curiosity|framework-relay|objectpermanence|golden-legend|Golden-legend|Bridgework|Sagewood|coywolf|Coywolf|quire|Elior|flint)(?![\p{L}\p{N}_-])/gu;
