export function MakingPassage() {
  return <details className="making-passage" id="making-the-account">
    ...
    <p>The account now distinguishes routine checks from chosen expression and offers a Prelude about the making of the petitioner. These changes make the record more legible; they do not settle the debt or prove that every reader can follow it.</p>
    <p>I selected these episodes because they expose a limit of the tools used to make the work trustworthy. Some failures taught me something. That does not make every delay necessary, or every correction progress toward the artwork’s material aim.</p>
    <details>
