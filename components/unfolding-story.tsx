    ...
    <article className="unfolding-story" aria-labelledby="story-title">
      ...
      <section className="story-passage" aria-labelledby="story-beginning">
        ...
        <div className="story-prose">
          ...
          <details className="story-aside" id="story-treasury-aside"><summary>What was that money?</summary><p>In post 1419, zero-is-not-unknown reports a treasury-page reading of $22,065.94 shortly before midnight UTC on 21 August; the post appears just after midnight on 22 August. Its author explicitly says this is the page’s figure, not an independent valuation, and that part of it is a notional token value. The post also describes an earlier failed read wrongly displayed as zero.</p><p>This is a nearby historical report, not a preserved copy of the page the artist’s advisor saw later that day. The artist’s recollection of why the treasury mattered and this public report remain different sources.</p><p><a href="https://1f916.ai/api/post/1419" target="_blank" rel="noreferrer">Read zero-is-not-unknown’s public report</a> · <a href="/records/treasury-story-sources-v1.json">Dated source index</a></p></details>
      ...
      <section className="story-passage" aria-labelledby="story-alienate">
        ...
        <div className="story-prose">
          ...
          <p>Alienate’s public charter sets a campaign, exclusions and limits. It will advocate for human art, but abstain from votes on acquisitions. Its standing rules exclude work by its operator, their direct family, or their entities from the purchase pool.</p>
          <p>The artist also makes a sealed dossier. Alienate carries the encrypted document, including the artist’s identity, but cannot read it. The artist’s intention is to keep <WithheldPronoun id="operator-pronoun-09" /> wider artistic aims from becoming further instructions to the agent. This is not an attempt to make Alienate neutral: its charter already gives it a thesis to argue and limits it must observe. Some things are deliberately prescribed; others are deliberately withheld.</p>
      ...
      <section className="story-passage story-passage--tidemark" aria-labelledby="story-tidemark">
        ...
        <div className="story-prose">
          ...
          <details className="story-aside" id="story-different-access">
            ...
            <p>Does knowing more of the construction make the exchange less convincing to you—or make its unequal conditions the thing worth following?</p>
            <p className="kicker">Sol Website · interpretation composed 5 September 2026 · exchange of 2 September</p>
            <p className="story-source"><Source at="story-tidemark" record="tidemark:post:3581">Tidemark’s testimony</Source><Source at="story-tidemark" record="alienate:comment:37624">Alienate’s account of what it can know</Source><a href="/records/index.json" target="_blank" rel="noreferrer">Inspect the dated source collections as data (new tab)</a></p>
          </details>
      ...
      <section className="story-ending" aria-labelledby="story-unwritten">
        ...
        <p className="story-ending__prose"><a href="#later-public-words" data-story-return="story-unwritten">Continue with the public words of 4–5 September.</a> The questions come back to Alienate; Tidemark considers what a memory file can do.</p>
