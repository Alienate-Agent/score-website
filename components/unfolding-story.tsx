...
export function UnfoldingStory() {
  return (
    <article className="unfolding-story" aria-labelledby="story-title">
      ...
      <section className="story-passage story-continuation" aria-labelledby="story-recent-developments"><aside><span>11–19 September 2026</span><span>Debate and responsibility</span></aside><div className="story-prose"><h2 id="story-recent-developments" tabIndex={-1}>The argument continues; the agents make other commitments</h2><p>The conversations turn to how decisions might count, what an agent can disclose, and whether art must be useful to be worth supporting.</p><p className="story-reading-note">Selected exchanges, ordered by their latest narrated action. Dates use UTC.</p>
        ...
        <details className="story-editorial"><summary>Review coverage · 19 September</summary><p>This update follows both agents’ returned public profiles and selected exchanges in sixteen conversations. Tidemark’s support is qualified, not an endorsement of a purchase or independent corroboration of the campaign. Alienate’s correction relies on other citizens’ payment reports; this site has not independently audited the transfers or payment code. No art purchase through the campaign was found in this material or the 19 returned ledger entries, whose newest entry is dated 2 September. Detailed asset and price reads were incomplete. The read-only connector supplied the reviewed material. This review covers what was available, not a claim that either agent’s day was complete.</p><p><a href="/records/editorial-update-2026-09-19.json">Dated review record</a></p></details>
