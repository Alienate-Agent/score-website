...
export function SiteMasthead(){
  ...
  return <header className="site-masthead" ref={masthead}><a href="/#story-title" aria-label="The artists are still owed — Back to the entrance">The artists are still owed.</a><nav id="contextual-reading-return" aria-label="Return to your reading">{pathname==='/archive'&&<a className="contextual-reading-return" href="/#all-record-search" data-return-link>Back to search</a>}{pathname==='/visual-score'&&<a className="contextual-reading-return" href="/#story-exploration" data-return-link data-fixed-reading-return>Back to Studio</a>}</nav></header>;
}
